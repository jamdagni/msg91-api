  ...
  <body>
    <form method="post" style="width:50ch;margin:auto">
      <div class="p-2 form">
        ...
        <button class="btn btn-success mt-3" type="submit" name="success">send otp</button>
...
//API URL
$url="http://control.msg91.com/api/otp.php";

$curl = curl_init($url);

curl_setopt_array($curl, array(
  //CURLOPT_URL => "http://control.msg91.com/api/v5/otp?authkey=YourAuthKey&sender=SenderID&template_id=TemplateID&extra_param=%7B%20%22Key%22:%22Value%22%7D&mobiles=MobileNumber",
